...
export const CHUNK_NAMES = ['terminal', 'browser'] as const
...
export function createBundleRouteHandler(
  ...
  return async (req, res): Promise<void> => {
    ...
    const match = /^\/powerdesk\/bundle\/([a-z0-9-]+)\.js$/.exec(pathname)
...
export function registerBundleRoute(ctx: Context, fence: (req: ResttyHttpRequest) => boolean): () => void {
