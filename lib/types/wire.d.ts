...
export type ResttyErrorCode = 'bad-request' | 'not-found' | 'forbidden' | 'method-error' | 'pty-error' | 'pty-deps-missing' | 'search-deps-missing' | 'sqlite-deps-missing' | 'calendar-no-profile' | 'internal';
