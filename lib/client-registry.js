window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/zteng/work/FortiSoc/dsh-powerdesk/src/client/restty.module.css.mjs
		const css$1 = "._1exSeW_terminalWrap{background:var(--dsw-alias-bg-base,#111114);flex-direction:column;width:100%;height:100%;min-height:0;display:flex;position:relative;overflow:hidden}._1exSeW_terminal{flex:auto;width:100%;height:100%;min-height:0}._1exSeW_terminalBanner,._1exSeW_terminalDepsBanner{z-index:5;text-align:center;color:var(--dsw-alias-label-primary,#e6e6e6);background:color-mix(in srgb, var(--dsw-alias-bg-base,#111114) 92%, transparent);backdrop-filter:blur(2px);flex-direction:column;justify-content:center;align-items:center;gap:10px;padding:18px 22px;font:13px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace;display:flex;position:absolute;inset:0}._1exSeW_terminalBannerUrl{opacity:.7;word-break:break-all;font-size:11px}._1exSeW_terminalRetry{border:1px solid var(--dsw-alias-stroke-default,#444);background:var(--dsw-alias-bg-elevated,#1b1b22);color:var(--dsw-alias-label-primary,#e6e6e6);cursor:pointer;font:inherit;border-radius:8px;align-self:center;padding:6px 14px}._1exSeW_terminalRetry:hover{filter:brightness(1.1)}._1exSeW_terminalDepsTitle{font-size:14px;font-weight:600}._1exSeW_terminalDepsHint{opacity:.85;max-width:520px}._1exSeW_terminalDepsCommandRow{align-items:stretch;gap:8px;width:100%;max-width:640px;display:flex}._1exSeW_terminalRepairCommand{text-align:left;white-space:pre-wrap;word-break:break-all;border:1px solid var(--dsw-alias-stroke-default,#444);background:var(--dsw-alias-bg-elevated,#1b1b22);border-radius:8px;flex:auto;margin:0;padding:8px 10px;font-size:12px}._1exSeW_terminalDepsNote{opacity:.7;max-width:560px;font-size:12px}._1exSeW_terminalDepsActions{gap:8px;display:flex}._1exSeW_editorPlaceholder,._1exSeW_editorError{text-align:center;height:100%;color:var(--dsw-alias-label-secondary,#abb2bf);justify-content:center;align-items:center;gap:10px;padding:16px;font:13px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace;display:flex}._1exSeW_editorError{color:var(--dsw-alias-label-primary,#e6e6e6);flex-direction:column}._1exSeW_standaloneToggle{z-index:2147483000;border:1px solid var(--dsw-alias-stroke-default,#444);background:var(--dsw-alias-bg-elevated,#1b1b22);color:var(--dsw-alias-label-primary,#e6e6e6);cursor:pointer;border-radius:999px;align-items:center;gap:6px;padding:8px 12px;font:12px/1 ui-monospace,SFMono-Regular,Menlo,monospace;display:inline-flex;position:fixed;bottom:14px;right:14px;box-shadow:0 4px 14px #00000059}._1exSeW_standaloneToggle:hover{filter:brightness(1.1)}._1exSeW_standaloneHost{z-index:2147483000;border:1px solid var(--dsw-alias-stroke-default,#444);background:var(--dsw-alias-bg-base,#111114);border-radius:12px;flex-direction:column;width:min(720px,92vw);height:min(440px,70vh);display:flex;position:fixed;bottom:56px;right:14px;overflow:hidden;box-shadow:0 10px 40px #00000073}._1exSeW_standaloneHeader{border-bottom:1px solid var(--dsw-alias-stroke-faint,#2a2a33);color:var(--dsw-alias-label-secondary,#abb2bf);justify-content:space-between;align-items:center;padding:6px 10px;font:11px/1 ui-monospace,SFMono-Regular,Menlo,monospace;display:flex}._1exSeW_standaloneNoSession{text-align:center;color:var(--dsw-alias-label-secondary,#abb2bf);padding:18px;font:13px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace}._1exSeW_standaloneSurfaceSwitch{background:var(--dsw-alias-bg-elevated,#1b1b22);border-radius:6px;gap:2px;padding:2px;display:inline-flex}._1exSeW_standaloneSurfaceBtn,._1exSeW_standaloneSurfaceActive{cursor:pointer;color:var(--dsw-alias-label-secondary,#abb2bf);background:0 0;border:none;border-radius:4px;padding:2px 10px;font:11px/1 ui-monospace,SFMono-Regular,Menlo,monospace}._1exSeW_standaloneSurfaceActive{background:var(--dsw-alias-interactive-bg-hover,#ffffff1f);color:var(--dsw-alias-label-primary,#e6e6e6)}._1exSeW_browser{flex-direction:column;flex:1;min-height:0;display:flex}._1exSeW_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1,#2a2a33);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}._1exSeW_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary,#abb2bf);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}._1exSeW_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#ffffff14);color:var(--dsw-alias-label-primary,#e6e6e6)}._1exSeW_iconButton:disabled{opacity:.4;cursor:default}._1exSeW_browserInput{border:1px solid var(--dsw-alias-border-l1,#2a2a33);background:var(--dsw-alias-bg-layer-1,#1b1b22);min-width:0;height:28px;color:var(--dsw-alias-label-primary,#e6e6e6);border-radius:6px;flex:1;padding:0 10px;font:12px/1 ui-monospace,SFMono-Regular,Menlo,monospace}._1exSeW_browserInput:focus{border-color:var(--dsw-alias-border-l2,#444);outline:none}._1exSeW_browserMessage{color:var(--dsw-alias-state-warn-label,#c8a951);background:var(--dsw-alias-state-warn-tertiary,#c8a9511a);flex:none;padding:4px 12px;font-size:11px}._1exSeW_browserFrame{background:var(--dsw-alias-bg-base,#111114);border:none;flex:1;width:100%;min-height:0}._1exSeW_browserStart{text-align:center;min-height:0;color:var(--dsw-alias-label-tertiary,#848891);flex:1;justify-content:center;align-items:center;padding:20px;font:13px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace;display:flex}._1exSeW_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary,#c8a951);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}._1exSeW_browserBlockedTitle{color:var(--dsw-alias-label-primary,#e6e6e6);font-size:12px;font-weight:600}._1exSeW_browserBlockedDesc{max-width:280px;color:var(--dsw-alias-label-secondary,#abb2bf);font-size:11px}._1exSeW_browserBlockedActions{gap:8px;margin-top:6px;display:flex}._1exSeW_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2,#444);background:var(--dsw-alias-bg-layer-1,#1b1b22);color:var(--dsw-alias-label-primary,#e6e6e6);cursor:pointer;border-radius:6px;padding:4px 12px;font-size:11px}._1exSeW_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover,#ffffff14)}._1exSeW_sandboxStatus{border-bottom:1px solid var(--dsw-alias-border-l1,#2a2a33);flex:none;align-items:center;gap:6px;padding:4px 10px;font-size:11px;display:flex}._1exSeW_sandboxStatusOn{color:var(--dsw-alias-state-success-label,#4eaa6e)}._1exSeW_sandboxStatusOff{color:var(--dsw-alias-state-warn-label,#c8a951);background:var(--dsw-alias-state-warn-tertiary,#c8a95114)}._1exSeW_sandboxDot{background:currentColor;border-radius:50%;flex:none;width:8px;height:8px}._1exSeW_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._1exSeW_sandboxAction{color:inherit;cursor:pointer;background:0 0;border:1px solid;border-radius:4px;flex:none;padding:2px 8px;font-size:11px}._1exSeW_sandboxAction:hover{opacity:.8}";
		const tagId$1 = "dsh-external/dsh-powerdesk/restty.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-external/dsh-powerdesk";
			tag.dataset.pluginCss = tagId$1;
			tag.textContent = css$1;
			document.head.appendChild(tag);
		}
		var restty_module_css_default = {
			"sandboxStatusOff": "_1exSeW_sandboxStatusOff",
			"browserBlockedDesc": "_1exSeW_browserBlockedDesc",
			"browserBlockedButton": "_1exSeW_browserBlockedButton",
			"terminalDepsNote": "_1exSeW_terminalDepsNote",
			"standaloneToggle": "_1exSeW_standaloneToggle",
			"terminalRetry": "_1exSeW_terminalRetry",
			"standaloneHeader": "_1exSeW_standaloneHeader",
			"standaloneSurfaceSwitch": "_1exSeW_standaloneSurfaceSwitch",
			"browserBlocked": "_1exSeW_browserBlocked",
			"browserBlockedTitle": "_1exSeW_browserBlockedTitle",
			"browserMessage": "_1exSeW_browserMessage",
			"standaloneSurfaceActive": "_1exSeW_standaloneSurfaceActive",
			"sandboxStatus": "_1exSeW_sandboxStatus",
			"browserBar": "_1exSeW_browserBar",
			"terminalRepairCommand": "_1exSeW_terminalRepairCommand",
			"terminalWrap": "_1exSeW_terminalWrap",
			"terminal": "_1exSeW_terminal",
			"browserInput": "_1exSeW_browserInput",
			"browserFrame": "_1exSeW_browserFrame",
			"terminalDepsCommandRow": "_1exSeW_terminalDepsCommandRow",
			"editorPlaceholder": "_1exSeW_editorPlaceholder",
			"browserStart": "_1exSeW_browserStart",
			"sandboxStatusOn": "_1exSeW_sandboxStatusOn",
			"terminalDepsTitle": "_1exSeW_terminalDepsTitle",
			"standaloneNoSession": "_1exSeW_standaloneNoSession",
			"standaloneHost": "_1exSeW_standaloneHost",
			"iconButton": "_1exSeW_iconButton",
			"editorError": "_1exSeW_editorError",
			"browser": "_1exSeW_browser",
			"sandboxDot": "_1exSeW_sandboxDot",
			"sandboxStatusText": "_1exSeW_sandboxStatusText",
			"terminalBanner": "_1exSeW_terminalBanner",
			"sandboxAction": "_1exSeW_sandboxAction",
			"terminalDepsActions": "_1exSeW_terminalDepsActions",
			"standaloneSurfaceBtn": "_1exSeW_standaloneSurfaceBtn",
			"terminalBannerUrl": "_1exSeW_terminalBannerUrl",
			"browserBlockedActions": "_1exSeW_browserBlockedActions",
			"terminalDepsBanner": "_1exSeW_terminalDepsBanner",
			"terminalDepsHint": "_1exSeW_terminalDepsHint"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/zteng/work/FortiSoc/dsh-powerdesk/src/client/sidebar.module.css.mjs
		const css = "._6XgVMq_toggleCluster{z-index:45;flex-direction:row;gap:4px;display:flex;position:fixed;top:3px;right:10px}._6XgVMq_panel:not(._6XgVMq_panelHidden) ._6XgVMq_tabBar{padding-right:72px}._6XgVMq_toggleButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), color var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;display:flex}._6XgVMq_toggleButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_toggleButton:disabled{opacity:.4;cursor:default}._6XgVMq_panel{z-index:41;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:fixed;top:0;bottom:0;right:0}._6XgVMq_panelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translate(102%)}._6XgVMq_panel[data-dragging]{transition:none}._6XgVMq_panelResize{cursor:col-resize;z-index:2;touch-action:none;width:8px;position:absolute;top:0;bottom:0;left:-4px}._6XgVMq_panelResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}._6XgVMq_panelBody{flex:1;min-width:0;min-height:0;display:flex}._6XgVMq_bottomPanel{z-index:40;background:var(--dsw-alias-bg-layer-1);border-top:1px solid var(--dsw-alias-border-l2);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:fixed;bottom:0;right:0}._6XgVMq_bottomPanelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translateY(102%)}._6XgVMq_bottomPanel[data-dragging]{transition:none}._6XgVMq_bottomResize{cursor:row-resize;z-index:2;touch-action:none;height:8px;position:absolute;top:-4px;left:0;right:0}._6XgVMq_bottomResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}._6XgVMq_bottomClose{z-index:4;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:3px;right:6px}._6XgVMq_bottomClose:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_bottomPanel ._6XgVMq_tabBar{padding-right:40px}body[data-dsh-title-bar-compat] ._6XgVMq_toggleCluster{top:calc(var(--dsh-title-bar-strip,40px) + 3px)}body[data-dsh-title-bar-compat] ._6XgVMq_panel{padding-top:var(--dsh-title-bar-strip,40px)}._6XgVMq_cornerHandle{left:-6px;bottom:calc(var(--dsh-sidebar-height,0px) + 6px);z-index:2;cursor:nwse-resize;touch-action:none;width:12px;height:12px;position:absolute}._6XgVMq_cornerHandle:hover,._6XgVMq_cornerHandle[data-dragging]{background:var(--dsw-alias-interactive-bg-hover-accent)}._6XgVMq_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._6XgVMq_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_iconButton:disabled{opacity:.4;cursor:default}._6XgVMq_workbench,._6XgVMq_split{flex:1;min-width:0;min-height:0;display:flex}._6XgVMq_splitRow{flex-direction:row}._6XgVMq_splitCol{flex-direction:column}._6XgVMq_splitChild{display:flex;position:relative;overflow:hidden}._6XgVMq_divider{z-index:3;touch-action:none;flex:none;position:relative}._6XgVMq_dividerRow:after,._6XgVMq_dividerCol:after{content:\"\";background:var(--dsw-alias-border-l2);transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);position:absolute}._6XgVMq_dividerRow{cursor:col-resize;width:7px;margin:0 -2px}._6XgVMq_dividerRow:after{width:1px;top:0;bottom:0;left:50%;transform:translate(-50%)}._6XgVMq_dividerCol{cursor:row-resize;height:7px;margin:-2px 0}._6XgVMq_dividerCol:after{height:1px;top:50%;left:0;right:0;transform:translateY(-50%)}._6XgVMq_divider:hover:after,._6XgVMq_dividerActive:after{background:var(--dsw-alias-interactive-bg-hover-accent)}._6XgVMq_pane{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}._6XgVMq_paneDrop{outline:1px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}._6XgVMq_dropOverlay{z-index:6;pointer-events:none;background:var(--dsw-alias-interactive-bg-hover-accent);opacity:.5;position:absolute}._6XgVMq_dropLeft{width:25%;top:0;bottom:0;left:0}._6XgVMq_dropRight{width:25%;top:0;bottom:0;right:0}._6XgVMq_dropUp{height:25%;top:0;left:0;right:0}._6XgVMq_dropDown{height:25%;bottom:0;left:0;right:0}._6XgVMq_dropCenter{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px;background:0 0;inset:25%}._6XgVMq_paneContent{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}._6XgVMq_paneTab{flex-direction:column;flex:1;min-height:0;display:flex}._6XgVMq_paneTabHidden{display:none}._6XgVMq_paneEmptyCards{flex-direction:column;flex:1;gap:20px;min-height:0;padding:28px 20px 20px;display:flex;overflow:hidden}._6XgVMq_paneEmptyHeader{text-align:left;flex-direction:row;flex:none;justify-content:space-between;align-items:flex-start;gap:12px;display:flex}._6XgVMq_paneEmptyHeaderText{flex-direction:column;gap:4px;min-width:0;display:flex}._6XgVMq_paneEmptyHeading{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);margin:0;line-height:1.3}._6XgVMq_paneEmptySubheading{font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:0;line-height:1.4}._6XgVMq_paneLayoutRadio{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}._6XgVMq_paneLayoutOption{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;transition:background .12s var(--dsh-ease-in-out,ease), color .12s var(--dsh-ease-in-out,ease);background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;display:inline-flex}._6XgVMq_paneLayoutOption:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_paneLayoutOptionSelected,._6XgVMq_paneLayoutOptionSelected:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-brand-primary)}._6XgVMq_paneEmptyControls{flex:none;align-items:center;gap:8px;display:inline-flex}._6XgVMq_paneCloseButton{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;transition:background .12s var(--dsh-ease-in-out,ease), color .12s var(--dsh-ease-in-out,ease), border-color .12s var(--dsh-ease-in-out,ease);border-radius:8px;justify-content:center;align-items:center;display:inline-flex}._6XgVMq_paneCloseButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l2)}._6XgVMq_paneCardGrid{flex:1;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));align-content:start;gap:12px;min-height:0;display:grid}._6XgVMq_paneCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;transition:background .12s var(--dsh-ease-in-out,ease), border-color .12s var(--dsh-ease-in-out,ease), transform .12s var(--dsh-ease-in-out,ease), box-shadow .12s var(--dsh-ease-in-out,ease);border-radius:10px;flex-direction:row;align-items:flex-start;gap:12px;padding:14px;display:flex}._6XgVMq_paneCardIcon{background:var(--dsw-alias-interactive-bg-hover-accent);width:36px;height:36px;color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;font-size:16px;display:flex}._6XgVMq_paneCardText{flex-direction:column;gap:2px;min-width:0;display:flex}._6XgVMq_paneCardLabel{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;overflow:hidden}._6XgVMq_paneCardDesc{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:1.4;display:-webkit-box;overflow:hidden}._6XgVMq_paneCard:hover:not(:disabled){background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-border-l2);transform:translateY(-1px);box-shadow:0 2px 8px #0000001f}._6XgVMq_paneCard:hover:not(:disabled) ._6XgVMq_paneCardIcon{background:var(--dsw-alias-interactive-bg-active)}._6XgVMq_paneCard:active:not(:disabled){box-shadow:none;transform:translateY(0)}._6XgVMq_paneCard:disabled{opacity:.45;cursor:default}._6XgVMq_tabBar{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);flex:none;align-items:stretch;height:34px;display:flex}._6XgVMq_tabBarDrop{outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}._6XgVMq_tabList{scrollbar-width:none;flex:1;min-width:0;display:flex;overflow-x:auto}._6XgVMq_tabList::-webkit-scrollbar{display:none}._6XgVMq_tab{min-width:64px;max-width:160px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);border-right:1px solid var(--dsw-alias-border-l1);cursor:pointer;user-select:none;background:0 0;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}._6XgVMq_tab:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_tabActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}._6XgVMq_tabTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._6XgVMq_tabBadge{min-width:16px;height:15px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;display:inline-flex}._6XgVMq_tabClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._6XgVMq_tabClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_tabBarPlus{background:var(--dsw-alias-bg-layer-1);width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border:none;border-radius:5px;flex:none;justify-content:center;align-self:center;align-items:center;margin:0 6px;padding:0;display:inline-flex;position:sticky;right:0}._6XgVMq_tabBarPlus:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_explorer{flex-direction:column;flex:1;min-height:0;display:flex}._6XgVMq_explorerHeader{flex:none;justify-content:space-between;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._6XgVMq_explorerRoot{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._6XgVMq_explorerBody{flex:1;min-height:0;padding:2px 6px 8px;overflow:hidden auto}._6XgVMq_explorerRow{width:100%;min-width:0;height:34px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;white-space:nowrap;animation:_6XgVMq_dsh-row-in .15s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex;overflow:hidden}._6XgVMq_explorerRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_explorerDir{font:var(--dsw-font-s-strong-14)}._6XgVMq_explorerRowActive{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_explorerHidden{opacity:.45}._6XgVMq_explorerSymlink{color:var(--dsw-alias-label-tertiary);flex:none}._6XgVMq_explorerBroken ._6XgVMq_explorerName{color:var(--dsw-alias-state-error-primary)}._6XgVMq_explorerName{text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._6XgVMq_explorerRef{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:none}._6XgVMq_explorerRef:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_explorerRow:hover ._6XgVMq_explorerRef,._6XgVMq_explorerRow:focus-within ._6XgVMq_explorerRef{display:inline-flex}._6XgVMq_explorerPill{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:inline-flex}._6XgVMq_explorerPill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_explorerPill:disabled{opacity:.4;cursor:default}._6XgVMq_explorerCopied{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._6XgVMq_explorerError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);cursor:default}@keyframes _6XgVMq_dsh-row-in{0%{opacity:0}}._6XgVMq_explorerEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}._6XgVMq_editor{flex-direction:column;flex:1;min-height:0;display:flex}._6XgVMq_editorHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:4px 8px;display:flex}._6XgVMq_editorTitle{min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._6XgVMq_editorStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}._6XgVMq_editorStatusError{color:var(--dsw-alias-state-error-primary)}._6XgVMq_dirtyDot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;flex:none;width:7px;height:7px}._6XgVMq_editorPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex:1;justify-content:center;align-items:center;padding:16px;display:flex}._6XgVMq_orphanedType{opacity:.7;overflow-wrap:anywhere;margin-top:8px;font-size:12px;display:block}._6XgVMq_editorBinary{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:12px;padding:24px 16px;display:flex}._6XgVMq_editorBinaryNotice{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._6XgVMq_editorDownloadLink{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), border-color var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:6px;align-items:center;gap:6px;padding:6px 14px;text-decoration:none;display:inline-flex}._6XgVMq_editorDownloadLink:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}._6XgVMq_editorError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);padding:12px 16px}._6XgVMq_editorBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}._6XgVMq_sandboxStatus{font:var(--dsw-font-xxxs-11);flex:none;align-items:center;gap:8px;padding:4px 10px;display:flex}._6XgVMq_sandboxStatusOn{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1)}._6XgVMq_sandboxStatusOff{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);border-bottom:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}._6XgVMq_sandboxDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:6px;height:6px}._6XgVMq_sandboxStatusOff ._6XgVMq_sandboxDot{background:var(--dsw-alias-state-error-primary)}._6XgVMq_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._6XgVMq_sandboxAction{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:2px 8px}._6XgVMq_sandboxAction:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_editorHtml{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._6XgVMq_browser{flex-direction:column;flex:1;min-height:0;display:flex}._6XgVMq_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}._6XgVMq_browserInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}._6XgVMq_browserInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}._6XgVMq_browserMessage{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}._6XgVMq_browserFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._6XgVMq_browserStart{text-align:center;min-height:0;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);flex:1;justify-content:center;align-items:center;padding:20px;display:flex}._6XgVMq_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}._6XgVMq_browserBlockedTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary)}._6XgVMq_browserBlockedDesc{max-width:280px;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary)}._6XgVMq_browserBlockedActions{gap:8px;margin-top:6px;display:flex}._6XgVMq_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-11);cursor:pointer;border-radius:6px;padding:4px 12px}._6XgVMq_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_editorCm{background:0 0;flex:1;min-height:0;overflow:hidden}._6XgVMq_editorCmHidden{display:none}._6XgVMq_editorCm .cm-editor{height:100%}._6XgVMq_editorCm .cm-editor.cm-focused{outline:none}._6XgVMq_editorModeToggle{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}._6XgVMq_editorModeButton{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 8px}._6XgVMq_editorModeButton:hover{color:var(--dsw-alias-label-primary)}._6XgVMq_editorModeActive{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}._6XgVMq_editorImageWrap{flex:1;justify-content:center;align-items:center;min-height:0;padding:12px;display:flex;overflow:auto}._6XgVMq_editorImage{object-fit:contain;max-width:100%;max-height:100%}._6XgVMq_editorMd{min-height:0;font:var(--dsw-font-xs-13);flex:1;padding:10px 14px;overflow-y:auto}._6XgVMq_selectionPopup{z-index:60;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;cursor:pointer;border-radius:6px;align-items:center;padding:0 10px;display:inline-flex;position:fixed;transform:translate(-50%,calc(-100% - 8px))}._6XgVMq_selectionPopup:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_editorPdf{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex}._6XgVMq_editorPdfToolbar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:flex-end;padding:6px 8px;display:flex}._6XgVMq_editorPdfStage{flex:1;min-height:0;display:flex;position:relative}._6XgVMq_editorPdfFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._6XgVMq_editorPdfFrameBlocked{pointer-events:none}._6XgVMq_editorPdfDragShield{z-index:4;pointer-events:none;background:0 0;position:absolute;inset:0}._6XgVMq_editorPdfDragShieldActive{pointer-events:auto}body[data-dsh-tab-dragging] ._6XgVMq_editorPdfFrame{pointer-events:none!important}body[data-dsh-tab-dragging] ._6XgVMq_editorPdfDragShield{pointer-events:auto!important}._6XgVMq_terminalWrap{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex;position:relative}._6XgVMq_terminal{flex:1;min-height:0;padding:6px 4px 6px 8px}._6XgVMq_terminal .xterm{height:100%}._6XgVMq_terminalBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}._6XgVMq_terminalBannerUrl{word-break:break-all;opacity:.85;flex-basis:100%;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._6XgVMq_boundaryError{z-index:50;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;align-items:flex-start;gap:8px;padding:16px;display:flex;position:fixed;top:0;bottom:0;right:0;overflow:auto}._6XgVMq_terminalRetry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;padding:1px 8px}._6XgVMq_terminalRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_terminalDepsBanner{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-direction:column;flex:none;gap:6px;padding:10px;display:flex}._6XgVMq_terminalDepsTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-state-warn-primary)}._6XgVMq_terminalDepsHint{opacity:.9}._6XgVMq_terminalDepsCommandRow{align-items:flex-start;gap:8px;display:flex}._6XgVMq_terminalRepairCommand{white-space:pre-wrap;word-break:break-all;user-select:text;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:4px;flex:1;max-height:160px;margin:0;padding:6px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:1.5;overflow:auto}._6XgVMq_terminalDepsNote{opacity:.85}._6XgVMq_terminalDepsActions{align-items:center;gap:8px;display:flex}._6XgVMq_tabBoundaryError{min-height:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;flex:1;align-items:flex-start;gap:8px;padding:12px 16px;display:flex;overflow:auto}._6XgVMq_git{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}._6XgVMq_gitHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._6XgVMq_gitBranchSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 6px}._6XgVMq_gitSection{border-top:1px solid var(--dsw-alias-border-l1)}._6XgVMq_gitSectionHeader{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);text-transform:uppercase;justify-content:space-between;align-items:center;padding:6px 12px 4px;display:flex}._6XgVMq_gitLink{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:none;padding:0}._6XgVMq_gitLink:hover:not(:disabled){text-decoration:underline}._6XgVMq_gitLink:disabled{opacity:.4;cursor:default}._6XgVMq_gitRow{min-height:34px;animation:_6XgVMq_dsh-row-in .15s var(--ds-ease-in-out);border-radius:8px;align-items:center;gap:6px;margin:0 6px;padding:0 8px;display:flex}._6XgVMq_gitRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_gitRowSelected{background:var(--dsw-alias-interactive-bg-active)}._6XgVMq_gitRowMain{cursor:pointer;text-align:left;background:0 0;border:none;flex:1;align-items:center;gap:8px;min-width:0;padding:3px 0;display:flex}._6XgVMq_gitBadge{width:20px;height:16px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;justify-content:center;align-items:center;display:inline-flex}._6XgVMq_gitName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._6XgVMq_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}._6XgVMq_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}._6XgVMq_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}._6XgVMq_gitDiff{border-top:1px solid var(--dsw-alias-border-l1);padding:8px}._6XgVMq_gitDiffTab{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}._6XgVMq_gitDiffTabHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._6XgVMq_gitDiffTabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._6XgVMq_gitDiffFile{align-items:baseline;gap:6px;padding:8px 2px 2px;display:flex}._6XgVMq_gitDiffFilePath{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._6XgVMq_gitDiffFileOld{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}._6XgVMq_gitDiffFileTag{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:0 6px}._6XgVMq_gitDiffHunk{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);gap:8px;padding:3px 2px;display:flex}._6XgVMq_gitDiffHunkHeader{color:var(--dsw-alias-label-secondary);flex:none}._6XgVMq_gitDiffHunkSection{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._6XgVMq_gitDiffLine{font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;align-items:stretch;min-width:0;line-height:20px;display:flex}._6XgVMq_gitDiffNum{text-align:right;width:36px;color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;padding-right:8px}._6XgVMq_gitDiffCode{flex:1;min-width:0;overflow:visible}._6XgVMq_gitDiffCtx{color:var(--dsw-alias-label-primary)}._6XgVMq_gitDiffDel{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent)}._6XgVMq_gitDiffAdd{color:var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent)}._6XgVMq_gitDiffMeta{padding-left:2px}._6XgVMq_gitDiffMetaText{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);font-style:italic}._6XgVMq_gitDiffExpand{width:100%;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-brand-primary);cursor:pointer;text-align:center;background:0 0;border:none;margin:4px 0;display:block}._6XgVMq_gitDiffExpand:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_gitConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin:0}._6XgVMq_gitCommit{border-top:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:8px 12px;display:flex}._6XgVMq_gitCommitInput{flex:1;min-width:0}._6XgVMq_gitCommitButton{background:var(--dsw-alias-button-primary-fill);height:26px;color:var(--dsw-alias-label-primary-inverted);font:var(--dsw-font-xxs-strong-12);cursor:pointer;border:none;border-radius:6px;flex:none;padding:0 12px}._6XgVMq_gitCommitButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}._6XgVMq_gitCommitButton:disabled{opacity:.45;cursor:default}._6XgVMq_gitLogRow{cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:5px 12px;display:flex}._6XgVMq_gitLogRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_gitLogLine1{align-items:baseline;gap:8px;min-width:0;display:flex}._6XgVMq_gitLogHash{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);flex:none}._6XgVMq_gitLogLine2{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;display:flex}._6XgVMq_gitLogRef{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-brand-primary);white-space:nowrap;border-radius:999px;flex:none;padding:0 5px}._6XgVMq_gitLogSubject{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._6XgVMq_gitLogMeta{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}._6XgVMq_gitLogMore{border:1px solid var(--dsw-alias-border-l2);width:calc(100% - 24px);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;margin:4px 12px 8px;padding:6px 0;display:block}._6XgVMq_gitLogMore:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_gitLogMore:disabled{opacity:.5;cursor:default}._6XgVMq_producedRow{flex-wrap:wrap;align-items:center;gap:8px;padding:4px 0;display:flex}._6XgVMq_producedLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._6XgVMq_producedChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:200px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;display:inline-flex;overflow:hidden}._6XgVMq_producedChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6XgVMq_producedChip span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._6XgVMq_producedMore{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._6XgVMq_toggleButton:focus-visible,._6XgVMq_bottomClose:focus-visible,._6XgVMq_iconButton:focus-visible,._6XgVMq_tab:focus-visible,._6XgVMq_tabClose:focus-visible,._6XgVMq_tabBarPlus:focus-visible,._6XgVMq_paneCard:focus-visible,._6XgVMq_paneLayoutOption:focus-visible,._6XgVMq_paneCloseButton:focus-visible,._6XgVMq_explorerRow:focus-visible,._6XgVMq_explorerRef:focus-visible,._6XgVMq_gitRowMain:focus-visible,._6XgVMq_gitLink:focus-visible,._6XgVMq_gitCommitButton:focus-visible,._6XgVMq_gitLogRow:focus-visible,._6XgVMq_gitLogMore:focus-visible,._6XgVMq_gitDiffExpand:focus-visible,._6XgVMq_terminalRetry:focus-visible,._6XgVMq_editorModeButton:focus-visible,._6XgVMq_editorDownloadLink:focus-visible,._6XgVMq_editorPptxButton:focus-visible,._6XgVMq_editorDocxZoomRange:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){._6XgVMq_panel,._6XgVMq_panelHidden,._6XgVMq_bottomPanel,._6XgVMq_bottomPanelHidden,._6XgVMq_toggleCluster,._6XgVMq_toggleButton,._6XgVMq_tab,._6XgVMq_tabBarPlus,._6XgVMq_paneCard,._6XgVMq_explorerRow,._6XgVMq_gitRow,._6XgVMq_divider,._6XgVMq_dividerRow:after,._6XgVMq_dividerCol:after{transition:none;animation:none}}@media (width<=767px){._6XgVMq_panel:not(._6XgVMq_panelHidden) ._6XgVMq_tabBar{padding-right:40px}._6XgVMq_tab{min-width:48px;max-width:128px}}._6XgVMq_settingsIntro{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);margin:0 0 12px}._6XgVMq_settingsGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;display:grid}._6XgVMq_settingsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);cursor:pointer;text-align:left;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:12px;flex-direction:column;gap:8px;padding:14px;display:flex;position:relative}._6XgVMq_settingsCard:hover{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_settingsCardIcon{background:var(--dsw-alias-bg-layer-2);width:32px;height:32px;color:var(--dsw-alias-label-primary);border-radius:9px;justify-content:center;align-items:center;display:flex}._6XgVMq_settingsCardTitle{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary)}._6XgVMq_settingsCardSubtitle{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._6XgVMq_settingsCardToggle{border:1px solid var(--dsw-alias-border-l2);color:#0000;cursor:pointer;background:0 0;border-radius:50%;justify-content:center;align-items:center;width:22px;height:22px;display:flex;position:absolute;top:12px;right:12px}._6XgVMq_settingsCardToggleOn{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-base);border-color:#0000}._6XgVMq_settingsHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);margin:12px 0 0}._6XgVMq_settingsMissing{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-radius:10px;margin:0;padding:12px}._6XgVMq_notesRoot{flex:1;min-height:0;display:flex}._6XgVMq_notesTree{flex-direction:column;flex:none;min-width:0;display:flex;overflow:hidden}._6XgVMq_notesEditor{flex-direction:column;flex:1;min-width:0;display:flex}._6XgVMq_notesBindPrompt{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:10px;padding:24px;display:flex}._6XgVMq_folderPickerPath{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:8px;margin-bottom:4px;padding-bottom:10px;display:flex}._6XgVMq_folderPickerList{height:320px;overflow:hidden auto}._6XgVMq_folderPickerFooter{justify-content:flex-end;gap:8px;display:flex}._6XgVMq_extSection{border-top:1px solid var(--dsw-alias-border-l1);margin-top:20px;padding-top:16px}._6XgVMq_extHeading{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);margin:0 0 8px}._6XgVMq_extWarning{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;margin:0 0 12px;padding:10px 12px}._6XgVMq_extActions{gap:8px;margin-bottom:12px;display:flex}._6XgVMq_extActions button,._6XgVMq_extPromptActions button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:8px;padding:6px 12px}._6XgVMq_extActions button:disabled,._6XgVMq_extPromptActions button:disabled{opacity:.5;cursor:default}._6XgVMq_extPromptPrimary{background:var(--dsw-alias-label-primary)!important;color:var(--dsw-alias-bg-base)!important;border-color:#0000!important}._6XgVMq_extList{flex-direction:column;gap:8px;display:flex}._6XgVMq_extRow{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-items:flex-start;gap:10px;padding:10px 12px;display:flex}._6XgVMq_extRowIcon{background:var(--dsw-alias-bg-layer-2);border-radius:8px;flex:none;justify-content:center;align-items:center;width:28px;height:28px;font-size:15px;line-height:1;display:flex}._6XgVMq_extRowBody{flex-direction:column;flex:auto;gap:2px;min-width:0;display:flex}._6XgVMq_extRowTitle{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary)}._6XgVMq_extRowMeta{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere}._6XgVMq_extRowPath{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);opacity:.75;overflow-wrap:anywhere}._6XgVMq_extRowRemove{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;background:0 0;border-radius:8px;flex:none;align-self:center;padding:5px 10px}._6XgVMq_extRowRemove:disabled{opacity:.5;cursor:default}._6XgVMq_extEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);margin:0}._6XgVMq_extError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:10px;margin:12px 0 0;padding:10px 12px}._6XgVMq_extPrompt{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;gap:8px;margin-bottom:12px;padding:12px;display:flex}._6XgVMq_extPromptHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);margin:0}._6XgVMq_extPromptFile{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0}._6XgVMq_extPromptField{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;display:flex}._6XgVMq_extPromptField input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:8px;padding:6px 10px}._6XgVMq_extPromptActions{justify-content:flex-end;gap:8px;display:flex}._6XgVMq_appearanceSection{border-top:1px solid var(--dsw-alias-border-l1);margin-top:20px;padding-top:16px}._6XgVMq_appearanceHeading{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);margin:0 0 8px}._6XgVMq_appearanceGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:12px;display:grid}._6XgVMq_appearanceFieldFull{grid-column:1/-1}._6XgVMq_appearanceField{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;display:flex}._6XgVMq_appearanceFieldLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary)}._6XgVMq_appearanceControl{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);box-sizing:border-box;border-radius:8px;width:100%;padding:6px 10px}._6XgVMq_appearanceControl:focus{border-color:var(--dsw-alias-border-l3,var(--dsw-alias-border-l2));outline:none}._6XgVMq_appearanceSelectTrigger{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);box-sizing:border-box;cursor:pointer;text-align:left;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;width:100%;padding:6px 10px;display:flex}._6XgVMq_appearanceSelectTrigger:hover{border-color:var(--dsw-alias-border-l3,var(--dsw-alias-border-l2))}._6XgVMq_appearanceSelectTrigger:focus-visible{border-color:var(--dsw-alias-border-l3,var(--dsw-alias-border-l2));box-shadow:0 0 0 2px var(--dsw-alias-interactive-bg-active,transparent);outline:none}._6XgVMq_appearanceSelectTrigger[data-placeholder]{color:var(--dsw-alias-label-tertiary)}._6XgVMq_appearanceSelectTrigger:disabled{opacity:.6;cursor:default}._6XgVMq_appearanceSelectCaret{color:var(--dsw-alias-label-tertiary);flex-shrink:0;align-items:center;display:inline-flex}._6XgVMq_appearanceSelectContent{min-width:var(--radix-select-trigger-width);max-height:var(--radix-select-content-available-height,280px);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-elevated,var(--dsw-alias-bg-base));z-index:1000;border-radius:8px;overflow:hidden;box-shadow:0 6px 24px #0000002e}._6XgVMq_appearanceSelectViewport{padding:4px}._6XgVMq_appearanceSelectItem{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);cursor:pointer;user-select:none;border-radius:6px;outline:none;align-items:center;gap:6px;padding:6px 8px;display:flex}._6XgVMq_appearanceSelectItem[data-highlighted]{background:var(--dsw-alias-interactive-bg-hover)}._6XgVMq_appearanceSelectItem[data-disabled]{opacity:.5;cursor:default}._6XgVMq_appearanceSelectIndicator{color:var(--dsw-alias-label-primary);flex-shrink:0;align-items:center;display:inline-flex}._6XgVMq_appearanceInlineToggle{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);cursor:pointer;text-underline-offset:2px;background:0 0;border:none;align-self:flex-start;margin-top:2px;padding:0;text-decoration:underline}._6XgVMq_appearanceInlineToggle:hover{color:var(--dsw-alias-label-secondary)}._6XgVMq_appearanceHint,._6XgVMq_appearanceReopenHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);margin:8px 0 0}._6XgVMq_appearanceReopenHint{font-style:italic}";
		const tagId = "dsh-external/dsh-powerdesk/sidebar.module.css";
		...
		var sidebar_module_css_default = {
			"bottomPanel": "_6XgVMq_bottomPanel",
			"producedChip": "_6XgVMq_producedChip",
			"appearanceField": "_6XgVMq_appearanceField",
			"editorBanner": "_6XgVMq_editorBanner",
			"terminalDepsHint": "_6XgVMq_terminalDepsHint",
			"dsh-row-in": "_6XgVMq_dsh-row-in",
			"paneTab": "_6XgVMq_paneTab",
			"tabBarPlus": "_6XgVMq_tabBarPlus",
			"extList": "_6XgVMq_extList",
			"gitLogRef": "_6XgVMq_gitLogRef",
			"terminalDepsNote": "_6XgVMq_terminalDepsNote",
			"extRowBody": "_6XgVMq_extRowBody",
			"dividerActive": "_6XgVMq_dividerActive",
			"editorDownloadLink": "_6XgVMq_editorDownloadLink",
			"tabList": "_6XgVMq_tabList",
			"gitLogLine1": "_6XgVMq_gitLogLine1",
			"settingsCardTitle": "_6XgVMq_settingsCardTitle",
			"explorerHeader": "_6XgVMq_explorerHeader",
			"dropLeft": "_6XgVMq_dropLeft",
			"notesEditor": "_6XgVMq_notesEditor",
			"bottomPanelHidden": "_6XgVMq_bottomPanelHidden",
			"appearanceSelectTrigger": "_6XgVMq_appearanceSelectTrigger",
			"editorDocxZoomRange": "_6XgVMq_editorDocxZoomRange",
			"settingsCard": "_6XgVMq_settingsCard",
			"panelResize": "_6XgVMq_panelResize",
			"workbench": "_6XgVMq_workbench",
			"browserFrame": "_6XgVMq_browserFrame",
			"paneTabHidden": "_6XgVMq_paneTabHidden",
			"editorPdfDragShield": "_6XgVMq_editorPdfDragShield",
			"appearanceGrid": "_6XgVMq_appearanceGrid",
			"paneDrop": "_6XgVMq_paneDrop",
			"paneLayoutRadio": "_6XgVMq_paneLayoutRadio",
			"editorPdfFrame": "_6XgVMq_editorPdfFrame",
			"extRowTitle": "_6XgVMq_extRowTitle",
			"terminalRepairCommand": "_6XgVMq_terminalRepairCommand",
			"explorerHidden": "_6XgVMq_explorerHidden",
			"terminalDepsTitle": "_6XgVMq_terminalDepsTitle",
			"gitBranchSelect": "_6XgVMq_gitBranchSelect",
			"browserStart": "_6XgVMq_browserStart",
			"gitLogMore": "_6XgVMq_gitLogMore",
			"extWarning": "_6XgVMq_extWarning",
			"toggleButton": "_6XgVMq_toggleButton",
			"pane": "_6XgVMq_pane",
			"editorPdfToolbar": "_6XgVMq_editorPdfToolbar",
			"gitCommitInput": "_6XgVMq_gitCommitInput",
			"terminalWrap": "_6XgVMq_terminalWrap",
			"sandboxStatusOn": "_6XgVMq_sandboxStatusOn",
			"tabBarDrop": "_6XgVMq_tabBarDrop",
			"paneCard": "_6XgVMq_paneCard",
			"paneCardIcon": "_6XgVMq_paneCardIcon",
			"folderPickerList": "_6XgVMq_folderPickerList",
			"dirtyDot": "_6XgVMq_dirtyDot",
			"editorImageWrap": "_6XgVMq_editorImageWrap",
			"gitCommitButton": "_6XgVMq_gitCommitButton",
			"splitCol": "_6XgVMq_splitCol",
			"bottomResizeActive": "_6XgVMq_bottomResizeActive",
			"gitDiffTabHeader": "_6XgVMq_gitDiffTabHeader",
			"git": "_6XgVMq_git",
			"editorBinaryNotice": "_6XgVMq_editorBinaryNotice",
			"tabBar": "_6XgVMq_tabBar",
			"split": "_6XgVMq_split",
			"gitDiffNum": "_6XgVMq_gitDiffNum",
			"gitLink": "_6XgVMq_gitLink",
			"notesTree": "_6XgVMq_notesTree",
			"editorBinary": "_6XgVMq_editorBinary",
			"dividerCol": "_6XgVMq_dividerCol",
			"notesRoot": "_6XgVMq_notesRoot",
			"editorModeButton": "_6XgVMq_editorModeButton",
			"explorerEmpty": "_6XgVMq_explorerEmpty",
			"browserBar": "_6XgVMq_browserBar",
			"notesBindPrompt": "_6XgVMq_notesBindPrompt",
			"explorerCopied": "_6XgVMq_explorerCopied",
			"editorStatus": "_6XgVMq_editorStatus",
			"sandboxStatusOff": "_6XgVMq_sandboxStatusOff",
			"editorHtml": "_6XgVMq_editorHtml",
			"terminalBanner": "_6XgVMq_terminalBanner",
			"browserMessage": "_6XgVMq_browserMessage",
			"appearanceSelectIndicator": "_6XgVMq_appearanceSelectIndicator",
			"extRowMeta": "_6XgVMq_extRowMeta",
			"browserBlocked": "_6XgVMq_browserBlocked",
			"paneContent": "_6XgVMq_paneContent",
			"gitDiffFileTag": "_6XgVMq_gitDiffFileTag",
			"appearanceHint": "_6XgVMq_appearanceHint",
			"explorerBody": "_6XgVMq_explorerBody",
			"dividerRow": "_6XgVMq_dividerRow",
			"gitConfirmDesc": "_6XgVMq_gitConfirmDesc",
			"tabTitle": "_6XgVMq_tabTitle",
			"explorerRoot": "_6XgVMq_explorerRoot",
			"editorImage": "_6XgVMq_editorImage",
			"producedLabel": "_6XgVMq_producedLabel",
			"paneEmptyHeader": "_6XgVMq_paneEmptyHeader",
			"explorerDir": "_6XgVMq_explorerDir",
			"sandboxAction": "_6XgVMq_sandboxAction",
			"paneCardText": "_6XgVMq_paneCardText",
			"explorerName": "_6XgVMq_explorerName",
			"gitLogRow": "_6XgVMq_gitLogRow",
			"gitRowMain": "_6XgVMq_gitRowMain",
			"sandboxDot": "_6XgVMq_sandboxDot",
			"explorerSymlink": "_6XgVMq_explorerSymlink",
			"gitDiffHunkHeader": "_6XgVMq_gitDiffHunkHeader",
			"extRow": "_6XgVMq_extRow",
			"gitCommit": "_6XgVMq_gitCommit",
			"gitSection": "_6XgVMq_gitSection",
			"paneEmptyControls": "_6XgVMq_paneEmptyControls",
			"editorCmHidden": "_6XgVMq_editorCmHidden",
			"explorerError": "_6XgVMq_explorerError",
			"selectionPopup": "_6XgVMq_selectionPopup",
			"settingsCardIcon": "_6XgVMq_settingsCardIcon",
			"editorPdf": "_6XgVMq_editorPdf",
			"editorTitle": "_6XgVMq_editorTitle",
			"gitDiffCtx": "_6XgVMq_gitDiffCtx",
			"gitLogHash": "_6XgVMq_gitLogHash",
			"browserInput": "_6XgVMq_browserInput",
			"gitDiffTabTitle": "_6XgVMq_gitDiffTabTitle",
			"settingsCardSubtitle": "_6XgVMq_settingsCardSubtitle",
			"tab": "_6XgVMq_tab",
			"appearanceInlineToggle": "_6XgVMq_appearanceInlineToggle",
			"editorMd": "_6XgVMq_editorMd",
			"gitName": "_6XgVMq_gitName",
			"settingsIntro": "_6XgVMq_settingsIntro",
			"gitDiffFilePath": "_6XgVMq_gitDiffFilePath",
			"gitDiffMeta": "_6XgVMq_gitDiffMeta",
			"gitDiffExpand": "_6XgVMq_gitDiffExpand",
			"browser": "_6XgVMq_browser",
			"appearanceHeading": "_6XgVMq_appearanceHeading",
			"gitBadge": "_6XgVMq_gitBadge",
			"producedMore": "_6XgVMq_producedMore",
			"dropCenter": "_6XgVMq_dropCenter",
			"gitDiff": "_6XgVMq_gitDiff",
			"paneEmptyCards": "_6XgVMq_paneEmptyCards",
			"terminal": "_6XgVMq_terminal",
			"folderPickerPath": "_6XgVMq_folderPickerPath",
			"panelHidden": "_6XgVMq_panelHidden",
			"extPrompt": "_6XgVMq_extPrompt",
			"extPromptField": "_6XgVMq_extPromptField",
			"paneLayoutOptionSelected": "_6XgVMq_paneLayoutOptionSelected",
			"dropUp": "_6XgVMq_dropUp",
			"explorerRowActive": "_6XgVMq_explorerRowActive",
			"terminalDepsCommandRow": "_6XgVMq_terminalDepsCommandRow",
			"bottomClose": "_6XgVMq_bottomClose",
			"editorStatusError": "_6XgVMq_editorStatusError",
			"extSection": "_6XgVMq_extSection",
			"terminalDepsBanner": "_6XgVMq_terminalDepsBanner",
			"gitDiffMetaText": "_6XgVMq_gitDiffMetaText",
			"explorer": "_6XgVMq_explorer",
			"extPromptFile": "_6XgVMq_extPromptFile",
			"gitDiffAdd": "_6XgVMq_gitDiffAdd",
			"editor": "_6XgVMq_editor",
			"editorPlaceholder": "_6XgVMq_editorPlaceholder",
			"gitDiffHunk": "_6XgVMq_gitDiffHunk",
			"editorModeActive": "_6XgVMq_editorModeActive",
			"appearanceReopenHint": "_6XgVMq_appearanceReopenHint",
			"paneCardDesc": "_6XgVMq_paneCardDesc",
			"gitDiffFile": "_6XgVMq_gitDiffFile",
			"panel": "_6XgVMq_panel",
			"toggleCluster": "_6XgVMq_toggleCluster",
			"editorError": "_6XgVMq_editorError",
			"editorPdfFrameBlocked": "_6XgVMq_editorPdfFrameBlocked",
			"gitEmpty": "_6XgVMq_gitEmpty",
			"paneCardGrid": "_6XgVMq_paneCardGrid",
			"boundaryError": "_6XgVMq_boundaryError",
			"producedRow": "_6XgVMq_producedRow",
			"gitRow": "_6XgVMq_gitRow",
			"browserBlockedActions": "_6XgVMq_browserBlockedActions",
			"gitError": "_6XgVMq_gitError",
			"appearanceSection": "_6XgVMq_appearanceSection",
			"paneEmptySubheading": "_6XgVMq_paneEmptySubheading",
			"folderPickerFooter": "_6XgVMq_folderPickerFooter",
			"extPromptActions": "_6XgVMq_extPromptActions",
			"gitDiffHunkSection": "_6XgVMq_gitDiffHunkSection",
			"paneEmptyHeading": "_6XgVMq_paneEmptyHeading",
			"terminalRetry": "_6XgVMq_terminalRetry",
			"gitHeader": "_6XgVMq_gitHeader",
			"gitDiffCode": "_6XgVMq_gitDiffCode",
			"appearanceFieldFull": "_6XgVMq_appearanceFieldFull",
			"iconButton": "_6XgVMq_iconButton",
			"appearanceSelectItem": "_6XgVMq_appearanceSelectItem",
			"extEmpty": "_6XgVMq_extEmpty",
			"editorHeader": "_6XgVMq_editorHeader",
			"editorPptxButton": "_6XgVMq_editorPptxButton",
			"settingsHint": "_6XgVMq_settingsHint",
			"paneCloseButton": "_6XgVMq_paneCloseButton",
			"gitSectionHeader": "_6XgVMq_gitSectionHeader",
			"tabBoundaryError": "_6XgVMq_tabBoundaryError",
			"editorPdfDragShieldActive": "_6XgVMq_editorPdfDragShieldActive",
			"panelResizeActive": "_6XgVMq_panelResizeActive",
			"gitLogSubject": "_6XgVMq_gitLogSubject",
			"splitChild": "_6XgVMq_splitChild",
			"explorerRow": "_6XgVMq_explorerRow",
			"cornerHandle": "_6XgVMq_cornerHandle",
			"gitDiffDel": "_6XgVMq_gitDiffDel",
			"gitLogLine2": "_6XgVMq_gitLogLine2",
			"extRowPath": "_6XgVMq_extRowPath",
			"dropDown": "_6XgVMq_dropDown",
			"appearanceFieldLabel": "_6XgVMq_appearanceFieldLabel",
			"divider": "_6XgVMq_divider",
			"browserBlockedTitle": "_6XgVMq_browserBlockedTitle",
			"gitRowSelected": "_6XgVMq_gitRowSelected",
			"editorModeToggle": "_6XgVMq_editorModeToggle",
			"browserBlockedButton": "_6XgVMq_browserBlockedButton",
			"gitPlaceholder": "_6XgVMq_gitPlaceholder",
			"extRowIcon": "_6XgVMq_extRowIcon",
			"gitDiffFileOld": "_6XgVMq_gitDiffFileOld",
			"appearanceControl": "_6XgVMq_appearanceControl",
			"settingsCardToggleOn": "_6XgVMq_settingsCardToggleOn",
			"explorerBroken": "_6XgVMq_explorerBroken",
			"explorerPill": "_6XgVMq_explorerPill",
			"extHeading": "_6XgVMq_extHeading",
			"extPromptHint": "_6XgVMq_extPromptHint",
			"sandboxStatusText": "_6XgVMq_sandboxStatusText",
			"orphanedType": "_6XgVMq_orphanedType",
			"extRowRemove": "_6XgVMq_extRowRemove",
			"settingsMissing": "_6XgVMq_settingsMissing",
			"tabClose": "_6XgVMq_tabClose",
			"tabBadge": "_6XgVMq_tabBadge",
			"tabActive": "_6XgVMq_tabActive",
			"browserBlockedDesc": "_6XgVMq_browserBlockedDesc",
			"paneEmptyHeaderText": "_6XgVMq_paneEmptyHeaderText",
			"gitDiffTab": "_6XgVMq_gitDiffTab",
			"appearanceSelectViewport": "_6XgVMq_appearanceSelectViewport",
			"terminalBannerUrl": "_6XgVMq_terminalBannerUrl",
			"settingsGrid": "_6XgVMq_settingsGrid",
			"appearanceSelectContent": "_6XgVMq_appearanceSelectContent",
			"paneCardLabel": "_6XgVMq_paneCardLabel",
			"editorPdfStage": "_6XgVMq_editorPdfStage",
			"bottomResize": "_6XgVMq_bottomResize",
			"panelBody": "_6XgVMq_panelBody",
			"sandboxStatus": "_6XgVMq_sandboxStatus",
			"extActions": "_6XgVMq_extActions",
			"appearanceSelectCaret": "_6XgVMq_appearanceSelectCaret",
			"dropRight": "_6XgVMq_dropRight",
			"extPromptPrimary": "_6XgVMq_extPromptPrimary",
			"dropOverlay": "_6XgVMq_dropOverlay",
			"settingsCardToggle": "_6XgVMq_settingsCardToggle",
			"gitDiffLine": "_6XgVMq_gitDiffLine",
			"splitRow": "_6XgVMq_splitRow",
			"paneLayoutOption": "_6XgVMq_paneLayoutOption",
			"gitLogMeta": "_6XgVMq_gitLogMeta",
			"extError": "_6XgVMq_extError",
			"explorerRef": "_6XgVMq_explorerRef",
			"terminalDepsActions": "_6XgVMq_terminalDepsActions",
			"editorCm": "_6XgVMq_editorCm"
		};
		//#endregion
		...
		*/
		...
		function TabBar(props) {
			const { paneId, tabs, active, onActivate, onClose, onNewPane, onDropTab, getTabIcon, getTabBadge } = props;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TabBar, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), parentSplitDir !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								type: "button",
								className: sidebar_module_css_default.paneCloseButton,
		...
		*/
		...
		function SidebarShell(props) {
			...
			(0, react$1.useEffect)(() => {
				...
				hostRoot.style.transition = draggingWidth || draggingHeight ? "none" : "margin-right var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out)";
