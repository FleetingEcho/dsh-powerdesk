	...
	factory: (require) => {
		...
		*/
		...
		const api = {
			...
			*  forbids being embedded (X-Frame-Options / frame-ancestors). */
			...
			searchGrep: (path, query, signal) => call("search.grep", {
				path,
				query
			}, signal),
		...
		*  descends from `root`). Exported for testing. */
		function relativeTo(root, path) {
			...
			if (path === normalizedRoot) return basenameOf$1(normalizedRoot);
		...
		*  (the tree is a browse view, not a live filesystem watcher). */
		...
		function FileExplorer(props) {
			...
			const addBookmark = (path) => {
				...
				const bookmark = {
					id: makeBookmarkId(),
					label: basenameOf$1(trimmed) || trimmed,
					path: trimmed
				};
				persist({
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: sidebar_module_css_default.explorerName,
							children: basenameOf(result.path)
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: sidebar_module_css_default.explorerCopied,
		...
		*/
		...
		const POWERDESK_SEARCH_TAB_ID = "dsh-powerdesk:search";
		...
		*  ripgrep — see SearchView.tsx. */
		function SearchTabView(props) {
			const { scope, onOpenFileAtLine } = props;
			return (0, react.createElement)(SearchView, {
				cwd: scope.cwd,
		...
		*  session; opening it again focuses the existing one instead of duplicating. */
		function buildSearchTabDescriptor() {
			return {
				id: POWERDESK_SEARCH_TAB_ID,
				title: () => t("searchTabTitle"),
				icon: (size) => (0, react.createElement)(IconSearch, { size }),
				order: 41,
				single: true,
				createTab: () => ({ tab: {
					id: POWERDESK_SEARCH_TAB_ID,
					type: POWERDESK_SEARCH_TAB_ID,
					title: t("searchTabTitle")
				} }),
				component: (props) => (0, react.createElement)(SearchTabView, props)
			};
		}
		/**
		...
		*/
		function apply(ctx) {
			...
			ctx.effect(() => service.registerTab(buildSearchTabDescriptor()), "dsh-powerdesk: search tab");
		...
		exports.POWERDESK_SEARCH_TAB_ID = POWERDESK_SEARCH_TAB_ID;
		exports.apply = apply;
